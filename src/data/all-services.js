...
export default [
    {
        title: {
            el: "Τακτικός καθαρισμός πισίνας",
            en: "Regular Pool Cleaning",
        },
        description: {
            el: "Ο τακτικός καθαρισμός της πισίνας εξασφαλίζει καθαρό και ασφαλές νερό για όλους τους χρήστες, προλαμβάνει την ανάπτυξη άλγης και μικροοργανισμών, και συμβάλλει στη σωστή λειτουργία όλου του συστήματος.",
    ...
    {
        title: {
            el: "Χημική εξισορρόπηση νερού",
            en: "Chemical Water Balancing",
        },
        description: {
            el: "Η σωστή χημική εξισορρόπηση του νερού είναι ζωτικής σημασίας για την υγιεινή της πισίνας, αποτρέπει τη διάβρωση του εξοπλισμού και μειώνει τον κίνδυνο μολύνσεων και ερεθισμών στους λουόμενους.",
    ...
    {
        title: {
            el: "Συντήρηση φίλτρων πισίνας",
            en: "Pool Filter Maintenance",
        },
        description: {
            el: "Η συντήρηση των φίλτρων είναι απαραίτητη για την αποτελεσματική απομάκρυνση ρύπων από το νερό. Ένα καθαρό φίλτρο συμβάλλει στην καλύτερη ποιότητα του νερού και μειώνει τη φθορά των εξαρτημάτων.",
    ...
    {
        title: {
            el: "Καθαρισμός πυθμένα και τοιχωμάτων",
            en: "Bottom and Wall Cleaning",
        },
        description: {
            el: "Η απομάκρυνση άλγης, αλάτων και άλλων επικαθίσεων από τον πυθμένα και τα τοιχώματα της πισίνας εξασφαλίζει καθαρότητα, αποτρέπει την ολίσθηση και συμβάλλει στη συνολική υγιεινή του χώρου.",
    ...
    {
        title: {
            el: "Καθαρισμός αντλιών και σωληνώσεων",
            en: "Pump and Pipe Cleaning",
        },
        description: {
            el: "Ο καθαρισμός αντλιών και σωληνώσεων αποτρέπει τις φραγές, διατηρεί την πίεση και τη ροή του νερού, και παρατείνει τη διάρκεια ζωής του εξοπλισμού, εξοικονομώντας χρήματα από μελλοντικές επισκευές.",
