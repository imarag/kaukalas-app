export default [
    {
        ...
        answer: {
            gr: "Προσφέρουμε μια σειρά υπηρεσιών που περιλαμβάνουν επαγγελματικό καθαρισμό πισίνας, συντήρηση εξοπλισμού, έλεγχο ισορροπίας χημικών, καθαρισμό φίλτρων και αναπλήρωση νερού για να διατηρείτε την πισίνα σας σε άριστη κατάσταση.",
    ...
    },
    {
        ...
        answer: {
            gr: "Ναι, προσφέρουμε υπηρεσίες επείγοντος καθαρισμού πισίνας για καταστάσεις που απαιτούν άμεση παρέμβαση. Μπορείτε να μας επικοινωνήσετε οποιαδήποτε στιγμή για επείγουσες ανάγκες συντήρησης της πισίνας.",
