        ...
        <>
            ...
            <footer className="footer footer--dark">
                <div className="footer__columns">
                    <div className="footer__column footer--company-logo">
                        <div className="footer__logo">
                            <img className="footer__logo-img" src={Logo} alt="logo of the page"/>
                        </div>
                        <div className="footer__social">
                            <div className="footer__app">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-instagram footer__svg" viewBox="0 0 16 16">
                            ...
                            <div className="footer__app">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-facebook footer__svg" viewBox="0 0 16 16">
                                    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
                                </svg>
                            </div>
                            <div className="footer__app">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-twitter footer__svg" viewBox="0 0 16 16">
                                    <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334q.002-.211-.006-.422A6.7 6.7 0 0 0 16 3.542a6.7 6.7 0 0 1-1.889.518 3.3 3.3 0 0 0 1.447-1.817 6.5 6.5 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.32 9.32 0 0 1-6.767-3.429 3.29 3.29 0 0 0 1.018 4.382A3.3 3.3 0 0 1 .64 6.575v.045a3.29 3.29 0 0 0 2.632 3.218 3.2 3.2 0 0 1-.865.115 3 3 0 0 1-.614-.057 3.28 3.28 0 0 0 3.067 2.277A6.6 6.6 0 0 1 .78 13.58a6 6 0 0 1-.78-.045A9.34 9.34 0 0 0 5.026 15"/>
                                </svg>
                            </div>
                        </div>
                    </div>
                    <div className="footer__column footer--company-info">
                        <h1 className="footer__title">Σχετικά με την εταιρία</h1>
                    ...
                    <div className="footer__column footer--sitemap">
                        <h1 className="footer__title">Sitemap</h1>
                        <ul className="footer__linklist">
                            <li className="footer__link">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-box-arrow-up-right footer__svg" viewBox="0 0 16 16">
                                    <path fillRule="evenodd" d="M8.636 3.5a.5.5 0 0 0-.5-.5H1.5A1.5 1.5 0 0 0 0 4.5v10A1.5 1.5 0 0 0 1.5 16h10a1.5 1.5 0 0 0 1.5-1.5V7.864a.5.5 0 0 0-1 0V14.5a.5.5 0 0 1-.5.5h-10a.5.5 0 0 1-.5-.5v-10a.5.5 0 0 1 .5-.5h6.636a.5.5 0 0 0 .5-.5"/>
                                    <path fillRule="evenodd" d="M16 .5a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h3.793L6.146 9.146a.5.5 0 1 0 .708.708L15 1.707V5.5a.5.5 0 0 0 1 0z"/>
                                </svg>
                                <NavLink className="footer__link-anchor" to="/">Αρχική Σελίδα</NavLink>
                            </li>
                            <li className="footer__link">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-box-arrow-up-right footer__svg" viewBox="0 0 16 16">
                                    <path fillRule="evenodd" d="M8.636 3.5a.5.5 0 0 0-.5-.5H1.5A1.5 1.5 0 0 0 0 4.5v10A1.5 1.5 0 0 0 1.5 16h10a1.5 1.5 0 0 0 1.5-1.5V7.864a.5.5 0 0 0-1 0V14.5a.5.5 0 0 1-.5.5h-10a.5.5 0 0 1-.5-.5v-10a.5.5 0 0 1 .5-.5h6.636a.5.5 0 0 0 .5-.5"/>
                                ...
                                <NavLink className="footer__link-anchor" to="/about">Σχετικά με εμάς</NavLink>
                            </li>
                            <li className="footer__link">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-box-arrow-up-right footer__svg" viewBox="0 0 16 16">
                                    <path fillRule="evenodd" d="M8.636 3.5a.5.5 0 0 0-.5-.5H1.5A1.5 1.5 0 0 0 0 4.5v10A1.5 1.5 0 0 0 1.5 16h10a1.5 1.5 0 0 0 1.5-1.5V7.864a.5.5 0 0 0-1 0V14.5a.5.5 0 0 1-.5.5h-10a.5.5 0 0 1-.5-.5v-10a.5.5 0 0 1 .5-.5h6.636a.5.5 0 0 0 .5-.5"/>
                                ...
                                <NavLink className="footer__link-anchor" to="/gallery">Τα έργα μας</NavLink>
                            </li>
                            <li className="footer__link">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-box-arrow-up-right footer__svg" viewBox="0 0 16 16">
                                    <path fillRule="evenodd" d="M8.636 3.5a.5.5 0 0 0-.5-.5H1.5A1.5 1.5 0 0 0 0 4.5v10A1.5 1.5 0 0 0 1.5 16h10a1.5 1.5 0 0 0 1.5-1.5V7.864a.5.5 0 0 0-1 0V14.5a.5.5 0 0 1-.5.5h-10a.5.5 0 0 1-.5-.5v-10a.5.5 0 0 1 .5-.5h6.636a.5.5 0 0 0 .5-.5"/>
                                ...
                                <NavLink className="footer__link-anchor" to="/contact">Επικοινωνία</NavLink>
                            </li> 
                        </ul>
                    </div>
                    <div className="footer__column footer--contact">
                        <h1 className="footer__title">Πληροφορίες Επικοινωνίας</h1>
                        <div className="footer__information">
                            <div className="footer__information-item">
                                <div className="footer__information-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-geo-alt-fill footer__svg" viewBox="0 0 16 16">
                            ...
                            <div className="footer__information-item">
                                <div className="footer__information-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-telephone-fill footer__svg" viewBox="0 0 16 16">
                            ...
                            <div className="footer__information-item">
                                <div className="footer__information-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-envelope-fill footer__svg" viewBox="0 0 16 16">
