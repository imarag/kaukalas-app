...
export default function RootLayout() {
    ...
    function handleMenuButtonClick() {
        const navOffcanvas = document.querySelector(".offnav")
    ...
    return (
        <>
            <header className="header">
                <nav className="offnav">
                    <div className="container">
                        <div className="offnav-menu">
                            <button className="offnav-close-button" onClick={handleOffCanvasCloseButton}>
                                <img src={XMarkSolid} alt="close button"/>
                            </button>
                        </div>
                ...
                <div className="main-nav">
                    <div className="container">
                        <div className="nav-logo">
                            <Link to="/">
                                <img src={LogoDark} alt="logo of the page"/>
                            </Link>
                        </div>
                        <nav>
                        ...
                        <button className="nav-toggle-button" onClick={handleMenuButtonClick}>
                            <img src={MenuBurger} />
                        </button>
                    </div>
                </div>
            ...
            <footer className="footer fs-small bg-primary text-light px-600 py-600">
